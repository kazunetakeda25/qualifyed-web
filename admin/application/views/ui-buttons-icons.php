                        ...
                        <div class="col-md-6">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <p>
                                        <button class="btn btn-default btn-ef btn-ef-3 btn-ef-3a mb-10"><i class="fa fa-shopping-cart"></i> Add to cart</button>
                                        <button class="btn btn-primary btn-rounded-10 btn-ef btn-ef-3 btn-ef-3b mb-10"><i class="fa fa-star"></i> Bookmark</button>
                                        <button class="btn btn-success btn-ef btn-ef-3 btn-ef-3c mb-10">Send data <i class="fa fa-arrow-right"></i></button>
                                    </p>

                                    <h4 class="custom-font"><strong>Button Effect</strong> 4</h4>
                                    <p>
                                        <button class="btn btn-default btn-border btn-rounded-20 btn-ef btn-ef-4 btn-ef-4a mb-10"> Continue <i class="fa fa-arrow-right"></i></button>
                                        <button class="btn btn-primary btn-border btn-rounded-20 btn-ef btn-ef-4 btn-ef-4b mb-10"> Continue <i class="fa fa-arrow-right"></i></button>
                                        <button class="btn btn-success btn-border btn-rounded-20 btn-ef btn-ef-4 btn-ef-4c mb-10"><i class="fa fa-arrow-left"></i> Return</button>
                                        <button class="btn btn-warning btn-border btn-rounded-20 btn-ef btn-ef-4 btn-ef-4d mb-10"><i class="fa fa-arrow-left"></i> Return</button>
                                    </p>

                                    <h4 class="custom-font"><strong>Button Effect</strong> 5</h4>
                                    <p>
                                        <button class="btn btn-default btn-ef btn-ef-5 btn-ef-5a mb-10"><i class="fa fa-shopping-cart"></i> <span>Add to cart</span></button>
                                        <button class="btn btn-primary btn-rounded btn-ef btn-ef-5 btn-ef-5a mb-10"><i class="fa fa-trash"></i> <span>Delete</span></button>
                                        <button class="btn btn-success btn-rounded-20 btn-ef btn-ef-5 btn-ef-5a mb-10"><i class="fa fa-cog"></i> <span>Settings</span></button>
                                        <button class="btn btn-warning btn-ef btn-ef-5 btn-ef-5b mb-10"><i class="fa fa-shopping-cart"></i> <span>Add to cart</span></button>
                                        <button class="btn btn-danger btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><i class="fa fa-trash"></i> <span>Delete</span></button>
                                        <button class="btn btn-info btn-rounded-20 btn-ef btn-ef-5 btn-ef-5b mb-10"><i class="fa fa-cog"></i> <span>Settings</span></button>
                                    </p>
                                    ...
                                    <p id="btn-click">
                                        <button class="btn btn-default btn-ef btn-ef-7 btn-ef-7a mb-10"><i class="fa fa-truck"></i> Order Item</button>
                                        <button class="btn btn-primary btn-ef btn-ef-7 btn-ef-7b mb-10"><i class="fa fa-envelope"></i> Send Message</button>
                                        <button class="btn btn-cyan btn-ef btn-ef-7 btn-ef-7h mb-10"><i class="fa fa-envelope"></i> Submit Form</button>
                                        <button class="btn btn-amethyst btn-ef btn-ef-7 btn-ef-7h mb-10"><i class="fa fa-envelope"></i> Submit Form</button>
                                        <button class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10"><i class="fa fa-arrow-right"></i> Submit</button>
                                        <button class="btn btn-greensea btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7d mb-10"><i class="fa fa-trash"></i> Delete</button>
                                        <button class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7e mb-10"><i class="fa fa-heart-o"></i> Like <i class="after fa fa-heart"></i></button>
                                        <button class="btn btn-danger btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7f mb-10"><i class="fa fa-star-o"></i> Star <i class="after fa fa-star"></i></button>
                                        <button class="btn btn-info btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7g mb-10"><i class="fa fa-plus"></i> Add <i class="after fa fa-plus"></i></button>
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Weather</strong> Icons</h1>
                                    <ul class="controls">
                                        <li class="dropdown" on-toggle="toggled(open)">

                                            <a href class="dropdown-toggle settings"><i class="fa fa-cog"></i></a>
                                            ...
                                            <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                                                ...
                                                <li>
                                                    <a href tile-control-fullscreen ng-click="isFullscreen = !isFullscreen">
                                ...
                                <div class="tile-body">
                                    ...
                                    <section id="sunny">
                                        <h4 class="page-header custom-font mt-20"><strong>Day / Sunny</strong> Icons</h4>
                                    ...
                                    <section id="cloudy">
                                        <h4 class="page-header custom-font"><strong>Neutral / Cloudy</strong> Icons</h4>
                                    ...
                                    <section id="night">
                                        <h4 class="page-header custom-font"><strong>Night / Moons</strong> Icons</h4>
                                    ...
                                    <section id="misc">
                                        <h4 class="page-header custom-font"><strong>Miscellaneous</strong> Icons</h4>
                                        ...
                                        <div class="row icons-list">
                                            ...
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-east"></i>
                                                wi-wind-east
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-north-east"></i>
                                                wi-wind-north-east
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-north-west"></i>
                                                wi-wind-north-west
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                            ...
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-south-east"></i>
                                                wi-wind-south-east
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-south-west"></i>
                                                wi-wind-south-west
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-south"></i>
                                                wi-wind-south
                                            </div>
                                            <div class="col-md-3 col-sm-4">
                                                <i class="wi wi-wind-west"></i>
                                                wi-wind-west
                                            </div>
