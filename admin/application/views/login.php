    ...
    <body id="minovate" class="appWrapper">
        ...
        <div id="wrap" class="animsition">
            <div class="page page-core page-login">
                <div class="text-center"><h3 class="text-light text-white"><img src="<?php echo base_url();?>assets/images/apple-icon-60x60.png"><span>Qualifyed</h3></div>
                <div class="container w-420 p-15 bg-white mt-40 text-center">
                <?php if(isset($error_message)) { ?> 
                		<div style="color: #FF0000"> <?php print_r($error_message); ?> </div>  <?php } ?>
                    <h2 class="text-light" style="color: #1761a0">Log In</h2>
                    <form name="login_form" action="" method="post" class="form-validation mt-20" novalidate="">
                        ...
                        <div class="form-group text-left mt-20">
                            <input type="submit" name="login" class="btn btn-primary b-0 br-2 mr-5" value="Login">
