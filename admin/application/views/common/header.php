...
<!--           <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/samples.css"> -->
        ...
        <script src="<?php echo base_url(); ?>assets/js/vendor/modernizr/modernizr-2.8.3-respond-1.4.2.min.js"></script>
         ...
         <script src="<?php echo base_url(); ?>assets/dist/sweetalert2.js"></script>
                    ...
                    <ul class="nav-right pull-right list-inline">
                        ...
                        <li class="dropdown nav-profile">
                            ...
                            <a href class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url(); ?>assets/images/admin.png" alt="" class="img-circle size-30x30">
                            ...
                            <ul class="dropdown-menu animated littleFadeInRight" role="menu">
                                ...
                                <li>
                                    <a role="button" tabindex="0" href="profile">
                                        <i class="fa fa-user"></i>Profile
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('logout'); ?>" role="button" tabindex="0">
