...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <head>
        ...
        <title>HelloWerk - Admin Dashboard</title>
    ...
    <body id="minovate" class="appWrapper">
        ...
        <div id="wrap" class="animsition">
            ...
            <div class="page page-core page-login">
                ...
                <div class="text-center"><h3 class="text-light text-white">HelloWerk</h3></div>
                ...
                <div class="container w-420 p-15 bg-white mt-40 text-center">
                    ...
                    <form name="form" class="form-validation mt-20">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control underline-input" placeholder="Full Name">
                        </div>
                    ...
                    <div class="bg-slategray lt wrap-reset mt-20 text-left">
                        <p class="m-0">
                            <a href="<?php echo site_url('admin/index') ?>" class="btn btn-greensea b-0 text-uppercase pull-right">Submit</a>
                            <a href="<?php echo site_url('admin/index') ?>" class="btn btn-lightred b-0 text-uppercase">Back</a>
                        </p>
                    </div>
