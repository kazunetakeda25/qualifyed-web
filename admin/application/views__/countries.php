         ...
         <div class="col-md-12">
            <section class="tile">
               ...
               <div class="tile-header dvd dvd-btm">
                  ...
                  <p class="add_new_c"><a role="button" data-toggle="modal" data-target="#changePass" data-options="changePass" href="javascript:void(0)" tabindex="0" class=" text-uppercase text-strong text-sm mr-10 btn btn-primary">ADD NEW COUNTRY</a> </p>
                  <ul class="controls">
                     <li class="dropdown">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <button class="btn btn-primary h3_label" id="COUNTRY_ACTION">Add Country</button>
