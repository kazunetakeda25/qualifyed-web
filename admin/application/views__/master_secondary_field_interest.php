...
<section id="content">
   <div class="page page-tables-datatables">
      <div class="pageheader">
         <h2>User Secondary Field Interest</h2>
         <div class="page-bar">
            <ul class="page-breadcrumb">
               ...
               <li>
                  <a href="<?php echo site_url('master_secondary_field_interest'); ?>">User Secondary Field Interest</a>
               </li>
            </ul>
         </div>
      </div>
         ...
         <div class="col-md-12">
            <section class="tile">
               ...
               <div class="tile-header dvd dvd-btm">
                  <h1 class="custom-font">Add User Secondary Field Interest</h1>
                     <div class="comapny_size_add">
                  <form id="size_com" method="POST" action="<?php echo site_url('admin/master_secondary_field_interest'); ?>">
                  <div class="row"> 
                  <div class="col-lg-6">            
                  <input type="text" id="myInput" class="form-control" name="name2" placeholder="Enter Company Type"></div>
                   <div class="col-lg-6">     
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <table class="table table-custom dataTable no-footer" id="editable-usage" role="grid" aria-describedby="editable-usage_info">
                                 ...
                                 <tbody>
                                   <?php 
                                   if($master_secondary_field_interest!="" && count($master_secondary_field_interest) >0)
                                   {
                                   foreach ($master_secondary_field_interest as $key => $value): ?>
                                    <tr class="gradeA odd" role="row">
                                      ...
                                      <td class="edit_v"><?php echo $value['name']; ?>
                                       ...
                                       <form id="Edit_form_click_<?php echo $key+1 ?>" class="edit_form_oc " method="POST">
                                            <div class="row"> 
                                            <div class="col-lg-6">            
                                            <input type="text" id="myInput<?php echo $value['id']?>"  class="form-control" value="<?php echo $value['name']; ?>" name="name_cs" placeholder="Enter States Name "></div>
                                             <div class="col-lg-6">
...
<script>
    ...
    if($.trim(misc) != '')
    {
      $.ajax({
        ...
        data : {table : 'master_secondary_field_interest', col : 'name',misc : misc,check_col_name : 'id', check_col_data : id  }
      }).then(function(res){
        ...
        swal("ERROR", "Please enter Secondary Field Interest", 'error');
    }
    return false;
  });
    ...
    $('.user_status').on('change', function(){
        ...
        $.ajax({
            method : "POST",
            url : "<?php echo site_url('admin/master_secondary_field_interest_status'); ?>",
            data : {status : status , id : $(this).data('id')}
        }).then(function(){
            swal("Update Success", 'Secondary Field Interest update successfully','success');
        })
    });
     $('#size_com').submit(function(e){
      if($('input[name="name2"]').val() == '')
      {
        swal("Please Enter Secondary Field Interest");
        return false;
      }else{
        return true;
      }
