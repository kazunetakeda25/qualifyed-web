...
export class ViewProfileComponent implements OnInit {
 ...
 virtual_status_user:any;
    ...
    showToggle(id, h) {
        ...
        this.user.post("getcomment", {
            ...
            //console.log("finalReply2222",this.allcomment)
        })
    }
    showToggleV2(id, j) {
 ...
 this.user.post("view_profile/workdaydata_profile",{userid:this.con_id}).subscribe(res => {
    ...
    cancel_reuest_api_v2(val) {
        ...
        this.http.post(this.api + '/cancel', this.cancel_id, httpOptions).subscribe(res => {
            this.rt.navigateByUrl('/test', {
                ...
                this.rt.navigate(["view_profile/" + val]));
            // this.ngOnInit()
    ...
    Comment(value, i) {
        ////////console.log("i onm",i,"co pi",value)
            ...
            if (result.value) {
                this.user.post("unfriend", {
                    ...
                    this.rt.navigateByUrl('/test', {
                        ...
                        this.rt.navigate(["view_profile/" + this.con_id]));
                    Swal.fire({
    ...
    sdInterviewReq() {
        ...
        this.user.GET('opportunity/getAllOpp').subscribe(res => {
            this.myOpp = res;
    ...
    intReqSubmit() {
        ...
        if (this.InterReq.invalid) {
            ...
            this.user.post('view_profile/directInterReq', this.InterReq.value).subscribe(res => {
                ////////console.log(res);
   ...
   this.user.post("getcommentreply",{id:id,limit:""+0+","+this.upperlimit1+"", i : i}).subscribe(res1 => {
    ...
    getOpportunity_status(){
       if (this.mycheck == 1) {
                ...
                this.set_login_id = this.checkusertype.id
            }
