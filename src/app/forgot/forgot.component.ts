 ...
 this.showLoader = true;
    this.user.forgotMail(this.forgotForm.value).subscribe(res=>{
      ...
      if(this.data == undefined){
       ...
       Swal.fire({text:"Email Address Not Found",type: "warning"})
      }
       ...
       Swal.fire({text:"your accound is deactivated",type: "warning"})
        ...
        Swal.fire({text:"Email has been  Sent  succesfully,please check your email",type: "success"})
        this.rt.navigate(['resetpassword'])
      }
