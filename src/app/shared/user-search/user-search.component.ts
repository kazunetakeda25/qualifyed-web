...
api = myGlobals.api_url;
 ...
 cc_id : any = 0;
  ...
  ngOnInit() {
    ...
    console.log("res this.searchAll",this.searchAll)
...
this.user.post("getsearchcount",{keyword:this.keyword,type:this.searchAll}).subscribe(res=>{
                  ...
                  if(res != null || res != undefined){
                   this.common=res
                  this.search_count=this.common.length;
                  }
     ...
     this.user.post("searchlog",{keyword:this.keyword,keyresult:JSON.stringify(this.filterData),userid:localStorage.getItem('id')}).subscribe(res=>{
                ...
                if(this.response.status == true){
                  this.user.post("searchresult",{keyword:this.keyword,type:this.searchAll,limit: '0,5'}).subscribe(res=>{
                         this.showLoader=false
                          this.common=res
                         this.datalength=this.common.length
                         this.data=res
