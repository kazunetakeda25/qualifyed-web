...
// @Component({
//   selector: 'app-resetpasswordtwo',
//   templateUrl: './resetpasswordtwo.component.html',
//   styleUrls: ['./resetpasswordtwo.component.css']
// })
// export class ResetpasswordtwoComponent implements OnInit {
