...
export class UserProfileComponent implements OnInit {
    ...
    ngOnInit(value = '') {
        ...
        this.user.post("opportunity/getinterviewcount",{userid:this.login_id}).subscribe(res => {
             this.showLoader=false
    ...
    load_more_comment_reply(id) {
        ...
        for (var i = 0; i < this.allcomment.length; ++i) {
            ...
            this.user.post("getcommentreply", {
                ...
                if (this.allcomment[res1[0].i].subcoment != undefined) {
                    this.disable_reply_button = this.allcomment[res1[0].i].subcoment.length
                }
            })
            //   this.user.post("get_total_count_comment_reply",{id:id,i : i}).subscribe(res2=>{
            //   this.common = res2;
            //    if(this.common.length > 0)
            //    {this.allcomment[res2[0].i].subcoment_count = this.common[0].count}
            // })
