...
export class SettingsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.addPhone.controls['cc'].setValue('1+US', {onlySelf: true });
 ...
 }else if (type == 2)
 {
   Swal.fire({
        ...
        this.user.post('setting/addNewEmailPost', this.addEmail.value).subscribe(res => {
            ...
            if (this.common.success == false) {
                ...
                Swal.fire({
                    ...
                    text: "We have sent a verification code to your email to verify email",
                    type: "success"
                });
            }
            document.getElementsByClassName('showEmailDiv')[0].classList.add('displayNone');
    ...
    addNewPhone() {
        ...
        var a = this.addPhone.value.cc;
        var ar = a.split('+');

        this.addPhone.value.phone =  ar[0] + this.addPhone.value.phone;
    ...
    resend_request(value) {
        ...
        this.http.post(this.api + '/requestconnection', {
            ...
            if ((this.connection.status == true)) {
                ...
                this.router.navigateByUrl('/shared/contact-us', {
