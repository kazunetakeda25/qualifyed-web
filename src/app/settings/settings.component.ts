...
export class SettingsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.user.post('setting/notificationSetting',{userid:this.login_id}).subscribe(res => {
          this.notSetting = [];
          this.common = res;
        ...
        this.user.GET("setting/getnotificationData").subscribe(res => {
        ...
        this.user.post('setting/getPassword',{userid:this.login_id}).subscribe(res => {
            this.common = res;
            if(this.common.length > 0)
            {
                this.password = res[0].created_date;
            }
        });
        ...
        this.historyPreg.controls['date_time'].setValue(0, {
            onlySelf: true
        });
     /*   this.historyPreg.controls['days'].setValue(1, {
            onlySelf: true
        });
        this.historyPreg.controls['unit'].setValue(0, {
            onlySelf: true
        });*/
    }
 ...
 get resErrSubmit() {
    ...
    showdiv(value) {
        ...
        if (value == 'div1') {this.show = 1; } else if (value == 'div2') {this.show1 = 1; } else if (value == 'div3') {this.show3 = 1 } else if (value == 'div4') {this.show4 = 1 } else if (value == 'div5') {this.show5 = 1 } else if (value == 'div6') {this.show6 = 1 } else if (value == 'div7') {this.show7 = 1 } else if (value == 'div8') {this.show8 = 1 } else if (value == 'div9') {this.show9 = 1 } else if (value == 'div10') {this.show10 = 1 }

    }
    hidediv(value) {

        if (value == 'div1') {this.show = 0; } else if (value == 'div2') {this.show1 = 0; } else if (value == 'div3') {this.show3 = 0 } else if (value == 'div4') {this.show4 = 0 } else if (value == 'div5') {this.show5 = 0 } else if (value == 'div6') {this.show6 = 0 } else if (value == 'div7') {this.show7 = 0 } else if (value == 'div8') {this.show8 = 0 } else if (value == 'div9') {this.show9 = 0 } else if (value == 'div10') {this.show10 = 0 }
    }
    showdivEducation(w) {
    ...
    changePasswordSub() {
        ...
        if (this.changePassword.value.new_password < 6) {
            Swal.fire({
                text: "Please enter minimun 6 characters",
                type: "error"
            });
            return false;
        }
    ...
    twoFactorFun(target, type) {
        ...
        if (type == 1) {
            Swal.fire({
                ...
                if (result.value) {
                    this.http.post(this.api + "/setting/two_factor_auth", {
                        is_tofactor_auth: 1
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.http.post(this.api + "/setting/two_factor_auth_disable", {
                        is_tofactor_auth: 0
                    }, httpOptions).subscribe(res => {
                        this.common = res;
                        if (this.common.success == true) {
    ...
    email_notification(target, type) {
        ...
        if (type == 1) {
            Swal.fire({
                ...
                if (result.value) {
                    this.http.post(this.api + "/setting/email_notification", {
                        is_emailnotification: 1
                    }, httpOptions).subscribe(res => {
                        this.common = res;
                        if (this.common.success == true) {
                            Swal.fire({
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.http.post(this.api + "/setting/email_notification_disable", {
                        is_emailnotification: 0
                    }, httpOptions).subscribe(res => {
                        this.common = res;
                        if (this.common.success == true) {
                            Swal.fire({
 ...
 }else if (type == 2)
 {
   Swal.fire({
    ...
    addNewEmail() {
        ...
        this.user.post('setting/addNewEmailPost', this.addEmail.value).subscribe(res => {
            ...
            if (this.common.success == false) {
                ...
                Swal.fire({
                    text: "Email add successfully, check email to verify your email",
                    type: "success"
                });
            }
            document.getElementsByClassName('showEmailDiv')[0].classList.add('displayNone');
    ...
    ResendOtp() {
        ...
        for (var i = 0; i < this.userPhone.length; ++i) {
            if (this.userPhone[i].id == this.gId) {
                this.user.post('setting/resendOtp', {
                    mN: this.userPhone[i].phone_number,
                    otp: this.userPhone[i].otp
                }).subscribe(res => {
                    Swal.fire({
    ...
    openModal(id) {
        ...
        this.addEmailVER.controls['otp'].setValue('', {
            onlySelf: true
        });
            ...
            if (result.value) {
                ...
                this.user.post(url, {
                    ...
                    if (this.common.success == false) {
                        ...
                        this.userEmails = res;
                        Swal.fire({
                            text: "Primary email set successfully",
                            type: "success"
                        });
                    }
                });
            ...
            if (result.value) {
                ...
                this.user.post(url, {
                    ...
                    if (this.common.success == false) {
                        ...
                        this.userPhone = res;
                        Swal.fire({
                            text: "Primary phone number set successfully",
                            type: "success"
                        });
                    }
                });
        ...
        Swal.fire({
            ...
            if (result.value) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.user.post('/setting/deleteaccount', {
                            password: result.value
                        }).subscribe(res => {
                            this.common = res;
                            if (this.common.success == false) {
    ...
    historySubmit() {
         this.submitted1 = true;
          if (this.historyPreg.invalid) {
            Swal.fire({
                title: "ERROR",
                html: "Please choose date for delete history",
                type: "error"
            });
            return;
        }
    ...
    resend_request(value) {
        ...
        this.http.post(this.api + '/requestconnection', {
            connection_id: value
        }, httpOptions).subscribe(res => {
            this.connection = res
    ...
    Unblock(user_id, blocked_id, name) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                this.user.post("setting/unblock", {
                    ...
                    if (this.block_status.status == true) {
                        Swal.fire({
                            text: "SUCCESS",
                            title: "User unblocked succesfully",
                            type: "success"
                        })
                        this.router.navigateByUrl('/test', {
                            skipLocationChange: true
                        }).then(() =>
                            this.router.navigate(["viewbusssinessconnection"]));
                    } else {
                        Swal.fire({
                            text: "Error",
                            type: "error"
    ...
    show_notification(title, id, type) {
        ...
        Swal.fire({
          ...
          if(result.dismiss)
          {
            ...
            if (result.value) {
                this.user.post("setting/changeNotificationSettings", {type : type , id : id}).subscribe(res => {
                    Swal.fire({
                        text: "SUCCESS",
