...
@Component({
  selector: 'app-view-userconnectionrequest',
  templateUrl: './view-userconnectionrequest.component.html',
  styleUrls: ['./view-userconnectionrequest.component.css']
})
export class ViewUserconnectionrequestComponent implements OnInit {
 ...
 finalConnections:any
  ...
  ngOnInit() {
    this.showLoader = true;
  	 ...
  	 {
           this.rt.navigate(['viewuserconnection']);
